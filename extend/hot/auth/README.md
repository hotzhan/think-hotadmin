...
> `rule`字段：grade1 `condition`字段：{score}<100 <br/>
> `rule`字段：grade2 `condition`字段：{score}>100 and {score}<200<br/>
> `rule`字段：grade3 `condition`字段：{score}>200 and {score}<300
